    ...
    <div class="mx-auto">
        ...
        <form method="POST" class="card" action="{{ route($routePath . '.update', ['free_trial' => $item]) }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-6 gap-4">
                ...
                <div class="flex flex-col col-span-2">
                    @include('admin/shared/input', ['name' => 'max_allowed_services', 'label' => __($translatePrefix . '.max_allowed_services'), 'value' => old('max_allowed_services', $item->max_allowed_services), 'help' => __($translatePrefix . '.help')])
                </div>
                <div class="flex flex-col col-span-2">
                    @include('admin/shared/input', ['name' => 'current_allowed_services', 'label' => __($translatePrefix . '.current_allowed_services'), 'value' => old('current_allowed_services', $item->current_allowed_services)])
